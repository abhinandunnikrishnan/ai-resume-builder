    ...
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="static " sx={{backgroundColor:'black'}}>
        <Toolbar>
          ...
          >
            {/* app icon */}
            <img width={'50px'} src="https://www.clipartmax.com/png/middle/308-3085721_resume-png-clipart-my-resume-icon-png.png" alt="icon" />
          </IconButton>
          <Typography variant="h5" component="div" sx={{ flexGrow: 1,fontFamily:'Poppins' }}>
